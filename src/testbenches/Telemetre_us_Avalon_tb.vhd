...
BEGIN
    ...
    BEGIN
        ...
        chipselect <= '1'; -- select chip when high
        read_n <= '0'; --read data when low
        WAIT FOR 10 us; -- wait some time
        --user stops reading data
        chipselect <= '0'; -- select chip when high
        read_n <= '1'; --read data when low
        ...
        --user selects chip without reading
        chipselect <= '1'; -- select chip when high
        read_n <= '1'; --read data when low
        WAIT FOR 10 us; -- wait some time
        --user stops reading data
        ...
        --user reads without chip select
        chipselect <= '0'; -- select chip when high
        read_n <= '0'; --read data when low
        WAIT FOR 10 us; -- wait some time
        --user stops reading data
